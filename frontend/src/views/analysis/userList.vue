  ...
  <div class="app-container">
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        ...
        <router-link :to="{path:'/user/user/edit'}" class="link-left">
    ...
    <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="role" label="等级"  :formatter="levelFormatter"/>
      ...
      <el-table-column width="350px" label="操作" align="center">
        <template #default="{row}">
          <router-link :to="'/analysis/screen'" class="link-left">
            <el-button size="small">数据可视化</el-button>
          </router-link>
          <router-link :to="{path:'/analysis/userAnalysis', query:{id:row.id}}" class="link-left">
            <el-button size="small">分析</el-button>
          </router-link>
          <router-link :to="{path:'/message/list', query:{id:row.id}}" class="link-left">
            <el-button size="small" >推荐</el-button>
          </router-link>
          <router-link :to="{path:'/message/list', query:{id:row.id}}" class="link-left">
            <el-button size="small" >推荐详情</el-button>
          </router-link>
        </template>
      </el-table-column>
    </el-table>
