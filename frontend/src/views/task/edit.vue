<template>
  <div class="app-container">
        ...
        <el-table  :data="form.paperItems" border fit highlight-current-row style="width: 100%">
          ...
          <el-table-column  label="操作" align="center"  width="160px">
            <template #default="{row}">
              <el-button size="small" type="danger" @click="removePaper(row)" class="link-left">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form-item>
    ...
    <el-dialog v-model="paperPage.showDialog" width="70%">
      ...
      <pagination v-show="paperPage.total>0" :total="paperPage.total"
                  v-model:page="paperPage.queryParam.pageIndex" v-model:limit="paperPage.queryParam.pageSize"
                  @pagination="search"/>
      <template #footer>
